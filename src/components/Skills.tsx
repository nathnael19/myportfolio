...
export default function Skills() {
  return (
    <section id="skills" className="py-24 bg-gray-50 dark:bg-[#050505] relative transition-colors duration-300">
              ...
              <div className="flex flex-wrap gap-3">
                {category.items.map((skill, skillIdx) => (
                  <motion.span
                    ...
                    whileInView={{ opacity: 1, y: 0 }}
                    viewport={{ once: true }}
                    transition={{ duration: 0.4, delay: (idx * 0.2) + (skillIdx * 0.05) }}
