    ...
    >
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="max-w-3xl mx-auto relative">
          {/* Vertical Line */}
          <div className="absolute left-6 md:left-1/2 top-0 bottom-0 w-px bg-gradient-to-b from-cyan-500/50 via-blue-600/50 to-transparent transform -translate-x-1/2" />
          ...
          <div className="space-y-12">
            {portfolioData.experience.map((exp, idx) => (
              ...
              >
                {/* Timeline Dot */}
                <div className="absolute left-6 md:left-1/2 top-6 transform -translate-x-1/2 -translate-y-1/2 w-10 h-10 sm:w-12 sm:h-12 rounded-full bg-white dark:bg-[#0a0a0a] border-2 border-cyan-500 flex items-center justify-center z-10 shadow-[0_0_15px_rgba(6,182,212,0.5)]">
