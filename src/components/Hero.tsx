  ...
  useEffect(() => {
    ...
    const timer = setTimeout(() => {
      if (!isDeleting && displayText === currentWord) {
        ...
        setIsDeleting(false);
        setCurrentTextIndex((prev) => (prev + 1) % portfolioData.personal.typingText.length);
      } else {
        setDisplayText(
      ...
      <div className="max-w-7xl mx-auto px-6 grid lg:grid-cols-2 gap-12 items-center relative z-10 w-full">
        ...
        >
          ...
          <div className="h-12 flex items-center">
            <p className="text-xl md:text-2xl font-medium text-gray-600 dark:text-gray-400">
              I am a <span className="text-gray-900 dark:text-white">{displayText}</span>
          ...
          <p className="text-lg text-gray-600 dark:text-gray-500 max-w-lg leading-relaxed">
            {portfolioData.personal.tagline}. I build scalable web applications and intuitive user interfaces with modern technologies.
          </p>
        ...
        >
          <div className="relative w-80 h-80 md:w-96 md:h-96">
            ...
            >
              <div className="text-cyan-600 dark:text-cyan-400 font-mono text-sm font-bold">&lt;/&gt;</div>
            </motion.div>
            <motion.div
              animate={{ y: [10, -10, 10] }}
            ...
            >
              <div className="text-blue-600 dark:text-blue-400 font-sans text-xs font-bold tracking-widest uppercase">React</div>
            </motion.div>
          </div>
        </motion.div>
      </div>
